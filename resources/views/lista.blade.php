...
<div class="">
<h2 class="text-center mt-4 mb-2" style="text-shadow: 2px 2px 0px #FFFFFF, 5px 4px 0px rgba(0,0,0,0.15)">Biblioteca de Livros</h2>
</div>
                ...
                <td>
                    <div class="btn-group" role="group">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                            ...
                            <li><a class="dropdown-item" href="{{ route('books.destroy', ['id' => $books->id]) }}">Deletar</a></li>
                        </ul>
                    </div>
                </td>
            </tr>
