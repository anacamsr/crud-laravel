...
<div class="col-8 m-auto">
   @if(isset($book))
    ...
    @endif
        ...
        <input class="form-control form-control-sm" type="text" name="title" id="title" value="{{$book->title ?? ''}}" placeholder="Título" aria-label=".form-select-sm example">
        <input class="form-control form-control-sm" type="text" name="price" id="price" value="{{$book->price ?? ''}}" placeholder="Preço" aria-label=".form-select-sm example">
